/* ==========================================================================
   ...
   light on purpose -- only geocode on "Find"/Enter (never as-you-type),
...
function skillbridgeDropPin(lat, lng, recenter) {
  if (!skillbridgeMarker) {
    ...
    skillbridgeMarker.on("dragend", function () {
      ...
      skillbridgeSetStatus("Pin set — drag it or click elsewhere on the map to move it.");
    });
  } else {
...
function initLocationPicker() {
  ...
  function runSearch() {
    ...
    if (!query) return;
    skillbridgeSetStatus("Looking up that address...");
  ...
  if (useMyLocationBtn) {
    useMyLocationBtn.addEventListener("click", function () {
      ...
      skillbridgeSetStatus("Getting your current location...");
  ...
  if (clearBtn) {
    clearBtn.addEventListener("click", function () {
      ...
      skillbridgeSetStatus("No location set yet. Click the map, search an address, or use your current location.");
    });
  }
}
