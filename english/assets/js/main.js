/* ==========================================================================
   ...
   - Team card glow border: flush size while "View Details" is open
   ========================================================================== */
...
(function () {
  ...
  /* ---- Logged-in nav swap --------------------------------------------
     index(ENG).html is a static file, so it can't check PHP's session
  ...
  /* ---- Team cards: glow border pulls flush when "View Details" opens - */
