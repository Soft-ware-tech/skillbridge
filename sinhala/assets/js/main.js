/* ==========================================================================
   ...
   - Team card glow border: flush size while "විස්තර බලන්න" is open
   ========================================================================== */
...
(function () {
  ...
  /* ---- Logged-in nav swap --------------------------------------------
     index(SIN).html is a static file, so it can't check PHP's session
  ...
  /* ---- Team cards: glow border pulls flush when "විස්තර බලන්න" opens - */
