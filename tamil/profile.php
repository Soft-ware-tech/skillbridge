...
<main class="profile-page">
  ...
  <?php if ($dbError): ?>
    <div class="empty-state">
      ...
      <h3>இந்த சுயவிவரத்தை ஏற்ற முடியவில்லை</h3>
  ...
  <?php elseif (!$freelancer): ?>
    <div class="empty-state">
      <div class="empty-glyph">◎</div>
      <h3>ஃப்ரீலான்சர் கிடைக்கவில்லை</h3>
      <p>இந்த சுயவிவரம் நீக்கப்பட்டிருக்கலாம், அல்லது இணைப்பு தவறாக உள்ளது.</p>
  ...
  <?php else: ?>
      ...
      <div class="profile-who">
        <div class="profile-name-row">
          ...
          <?php if ((int) $freelancer['verified_badge'] === 1): ?>
            <span class="verified-pill">✓ SkillBridge.lk ஆல் சரிபார்க்கப்பட்டது</span>
          <?php endif; ?>
        </div>
        ...
        <div class="profile-actions">
          <a href="#services" class="btn btn-primary">சேவைகளைக் காண்க</a>
          <a href="messages.php?with=<?php echo (int) $freelancer['user_id']; ?>" class="btn btn-outline">செய்தி</a>
        </div>
      </div>
    </section>
    ...
    <?php if ($freelancer['latitude'] !== null && $freelancer['longitude'] !== null): ?>
      <section class="profile-section">
        <p class="eyebrow">இருப்பிடம்</p>
        <h2 class="section-title"><?php echo htmlspecialchars(explode(' ', $freelancer['full_name'])[0], ENT_QUOTES); ?> இருக்குமிடம்</h2>
        ...
        <div id="profileMap"
             ...
             role="img" aria-label="இந்த ஃப்ரீலான்சரின் தோராயமான இருப்பிடத்தைக் காட்டும் வரைபடம்">
        </div>
        ...
        <a class="directions-link"
           ...
           target="_blank" rel="noopener">வழிகளைப் பெறுங்கள் ↗</a>
      </section>
    <?php endif; ?>

    <!-- =========================== SERVICES =========================== -->
    <section class="profile-section" id="services">
      <p class="eyebrow">சேவைகள்</p>
      <h2 class="section-title"><?php echo htmlspecialchars(explode(' ', $freelancer['full_name'])[0], ENT_QUOTES); ?> வழங்கும் சேவைகள்</h2>

      <?php if (empty($services)): ?>
        <div class="empty-state empty-state--inline">
          <p>இதுவரை செயலில் உள்ள சேவைகள் பட்டியலிடப்படவில்லை.</p>
        </div>
      <?php else: ?>
          ...
          <?php foreach ($services as $svc): ?>
            <div class="service-card">
              ...
              <div class="service-cta">
                ...
                <a href="booking.php?service=<?php echo (int) $svc['service_id']; ?>" class="btn btn-primary">இப்போது முன்பதிவு செய்யுங்கள்</a>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
    ...
    <!-- =========================== REVIEWS =========================== -->
    <section class="profile-section">
      <p class="eyebrow">கருத்து</p>
      <h2 class="section-title">வாடிக்கையாளர் மதிப்புரைகள்</h2>

      <?php if (empty($reviews)): ?>
        <div class="empty-state empty-state--inline">
          <p>இதுவரை மதிப்புரைகள் இல்லை — முன்பதிவு செய்து முதலில் ஒன்றை எழுதுங்கள்.</p>
        </div>
      <?php else: ?>
